...
class ArrayProcessingTest {
  ...
  void findLargestSubarraySumThrowsExceptionWithEmptyArrayInput() {
    assertThrows(
        IllegalArgumentException.class, () -> ArrayProcessing.findLargestSubarraySum(EMPTY_ARRAY));
  }
  ...
  void swapElementsThrowsExceptionWithEmptyArrayInput() {
    assertThrows(
        IllegalArgumentException.class, () -> ArrayProcessing.swapElements(EMPTY_ARRAY, 1, 2));
  }
}
