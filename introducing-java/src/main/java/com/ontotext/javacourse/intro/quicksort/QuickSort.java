...
/**
 * The QuickSort class provides a single method sort which sorts a given integer array in ascending
 * order and displays the result to the screen.
 */
public final class QuickSort {
  ...
  /**
   * Sorts the given method(by calling the quickSort method) and displays the sorted method to the
   * screen.
   *
  ...
  /**
   * Sorts the given array from startIndex to endIndex and returns the index of the array pivot.
   *
   * @param array the array to be sorted
   * @param startIndex the start index of the subarray
   * @param endIndex the end index of the subarray
