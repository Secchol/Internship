...
/**
 * The class GCDandLCM contains two methods FindGCD and FindLCM used for finding the Greatest common
 * divisor(GCD) of two integers and the Least common multiple(LCM) of two integers.
 */
public final class GCDandLCM {
  ...
  /**
   * The findLCM method depends on the findGCD method and returns the least common multiple of two
   * integers.
   *
   * @param firstNumber the first number
   * @param secondNumber the second number
