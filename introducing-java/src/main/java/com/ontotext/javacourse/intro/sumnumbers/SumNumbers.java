...
public final class SumNumbers {
  ...
  /**
   * Sums two numbers given as strings that can have unlimited length. The sum method is used for
   * summing large numbers because it implements the algorithm for summing.
   *
  ...
  public static String sum(String firstNumber, String secondNumber) {
    ...
    String shorterNumber =
        firstNumber.length() < secondNumber.length() ? firstNumber : secondNumber;
