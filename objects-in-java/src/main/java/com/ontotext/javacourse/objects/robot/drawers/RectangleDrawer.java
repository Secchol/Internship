...
/**
 * The RectangleDrawer class provides draw method which can draw a rectangle using a given OntoRobot robot.
 */
@NoArgsConstructor
public class RectangleDrawer extends SquareDrawer {
    ...
    public void draw(Figure figure, OntoRobot robot) {
        ...
        super.drawRectangle(rectangle.getX(), rectangle.getY(), rectangle.getLength(), rectangle.getWidth(), robot);
    }
}
